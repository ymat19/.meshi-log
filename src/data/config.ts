...
export const config: Config = {
  ...
  //
  // エネルギー2,000kcalと、トレーナーのご提案プランのPFC
  // (たんぱく質126g/脂質37g/炭水化物210g)は固定値。ここは動かさない。
  // 2,000kcalは消費2,101kcal/日に対して約100kcalの赤字を作る設定値であって、
  // 基礎代謝の値ではない。170cm・75kg・29歳男性の基礎代謝は1,600〜1,700kcal程度
  // (Mifflin-St Jeor 1,673 / 国立健康・栄養研究所の式 1,615)で、2,000はそれより
  // 300kcalほど上。摂取量を基礎代謝と比べて語らないこと。
  ...
  // 本人: 男性29歳・170cm・75kg・BMI26.0・目標73kg・運動週1、消費2,101kcal/日。
